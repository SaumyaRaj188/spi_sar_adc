module spi_adc (adc_clk_out,
 ...
 sky130_fd_sc_hd__a21o_1 _325_ (.A1(_136_),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__a32o_1 _326_ (.A1(bit_start),
    .A2(_159_),
    .A3(_160_),
    .B1(net28),
    .B2(\u_spi.pay[1] ),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__o21a_1 _327_ (.A1(bit_start),
    .A2(bit_auto),
    .B1(bit_en),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a21oi_1 _328_ (.A1(bit_en),
    .A2(net21),
    .B1(_161_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3b_2 _345_ (.A(_164_),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__nor2_1 _346_ (.A(\clk_cnt[0] ),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _393_ (.A1(_153_),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__o21a_1 _394_ (.A1(\u_spi.bit_cnt[2] ),
    .A2(_196_),
    .B1(_195_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _396_ (.A(_188_),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__o211a_1 _397_ (.A1(\u_spi.bit_cnt[3] ),
    .A2(_194_),
    .B1(_198_),
    .C1(_154_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _399_ (.A(_186_),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__a31o_1 _400_ (.A1(\u_spi.bit_cnt[4] ),
    .A2(_154_),
    .A3(_198_),
    .B1(_062_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _439_ (.A(net26),
    ...
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__a22o_1 _440_ (.A1(\u_spi.miso_buffer[0] ),
    .A2(net31),
    .B1(_221_),
    .B2(_225_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4b_1 _445_ (.A_N(net29),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__o22a_1 _446_ (.A1(\u_spi.miso_buffer[1] ),
    .A2(net32),
    .B1(_226_),
    .B2(_230_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _449_ (.A(_223_),
    ...
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__o22a_1 _450_ (.A1(\u_spi.miso_buffer[2] ),
    .A2(net32),
    .B1(_231_),
    .B2(_233_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _453_ (.A1(_140_),
    ...
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__o22a_1 _454_ (.A1(\u_spi.miso_buffer[3] ),
    .A2(net32),
    .B1(_234_),
    .B2(_236_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _457_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__o22a_1 _458_ (.A1(\u_spi.miso_buffer[4] ),
    .A2(net32),
    .B1(_237_),
    .B2(_239_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _461_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__o22a_1 _462_ (.A1(\u_spi.miso_buffer[5] ),
    .A2(net32),
    .B1(_240_),
    .B2(_242_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _465_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__o22a_1 _466_ (.A1(\u_spi.miso_buffer[6] ),
    .A2(_216_),
    .B1(_243_),
    .B2(_245_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _469_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__o22a_1 _470_ (.A1(\u_spi.miso_buffer[7] ),
    .A2(net32),
    .B1(_246_),
    .B2(_248_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _473_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__o22a_1 _474_ (.A1(\u_spi.miso_buffer[8] ),
    .A2(net32),
    .B1(_249_),
    .B2(_251_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _477_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__o22a_1 _478_ (.A1(\u_spi.miso_buffer[9] ),
    .A2(net32),
    .B1(_252_),
    .B2(_254_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _481_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__o22a_1 _482_ (.A1(\u_spi.miso_buffer[10] ),
    .A2(net32),
    .B1(_255_),
    .B2(_257_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _485_ (.A(net29),
    ...
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__o22a_1 _486_ (.A1(\u_spi.miso_buffer[11] ),
    .A2(net32),
    .B1(_258_),
    .B2(_260_),
    .VGND(VGND),
